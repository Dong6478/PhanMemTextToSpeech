...
def ma_hoa(chuoi, khoa_dich = 3, khoa_bien_doi = 2):
    ...
    luu_file(chuoi_ma_hoa, 'data.dat')
    return chuoi_ma_hoa
...
def doc_file(ten_file):
    ...
    return chuoi_ma_hoa
def giai_ma(chuoi_can_giai_ma = "" , optional = 1,khoa_dich = 3, khoa_bien_doi = 2):
    chuoi_goc = ""
    chuoi_ma_hoa = doc_file('data.dat') if optional == 1 else chuoi_can_giai_ma
